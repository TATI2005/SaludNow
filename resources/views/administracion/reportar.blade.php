...
<body>
    ...
    <nav class="navbar navbar-mobile navbar-expand-md navbar-dark bg-sidebar shadow-sm w-100 p-3">
        <div class="container-fluid p-0">
            ...
            <button class="navbar-toggler border-0 p-0" type="button"
                    data-bs-toggle="collapse" data-bs-target="#navMobileMenu"
                    aria-controls="navMobileMenu" aria-expanded="false">
            ...
            <div class="collapse navbar-collapse mt-3" id="navMobileMenu">
                ...
                <div class="dropdown pb-2">
                    <a href="#" class="gap-2 d-flex align-items-center text-white text-decoration-none dropdown-toggle"
                       id="mobUser" data-bs-toggle="dropdown">
                        <img src="https://ui-avatars.com/api/?name={{ session('medico.nombre') }}&background=89cbca&color=1f5945"
    ...
    <div class="sidebar-desktop bg-sidebar p-3 text-white shadow-sm">
        <a href="/" class="d-flex align-items-center mb-3 me-md-auto text-white text-decoration-none">
            ...
            <span class="fs-5 fw-bold">SaludAdmin</span>
        </a>
        <hr class="my-2">
        ...
        <hr class="my-2">
        <div class="dropdown">
            <a href="#" class="gap-2 d-flex align-items-center text-white text-decoration-none dropdown-toggle py-1"
